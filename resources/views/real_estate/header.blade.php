    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-4 col-sm-4 col-4 col-lg-2">
                ...
                {{-- <div class="logo">
                    <a href="{{ route('home') }}">
                        <a href="{{ route('home') }}"><img src="{{ asset('public/assets/global/images/logo/hikal-logo.png') }}" alt="Logo Image"></a>
                    </a>
                </div> --}}
                <!-- Logo Area End   -->
            </div>
            <div class="col-md-8 col-lg-7 menu-items">
                ...
                <nav class="header-menu">
                    <ul class="primary-menu">
                        ...
                        <li><a class="listing-btn sm-show-btn" href="{{ route('selectListigForMyListings') }}">+
                                {{ get_phrase('Add Listing') }}</a></li>
                        ...
                        <div class="user-profile">
                            ...
                            <ul class="dropdown-menu dropmenu-end">
                                @if (auth()->user()->role == 'user')
                                    <li><a class="dropdown-item" href="{{ route('customerAccount') }}"><i
