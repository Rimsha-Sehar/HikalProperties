                    ...
                    @foreach ($property_category as $category)
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb__20 wow fadeInUp" data-wow-duration="1000ms"
                            ...
                            <div class="single-building mr-14">
                                <span>
                                    <img src="{{ asset('public/uploads/real_estate/property-image/' . $category->property_image) }}"
                                        alt="">
                                </span>
                                <h4>{{ $category->type }}</h4>
...
<section class="new_antrygallary wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="600ms">
        ...
        <div class="row">
            @foreach ($states as $key => $state)
                ...
                @if ($key >= 0 && $key <= 1)
                    ...
                    @endif
                    @if ($key == 0)
                        <div class="col-lg-12 col-md-6 col-sm-12  mb-20 mr-10 wow fadeInUp" data-wow-duration="1000ms"
                            ...
                            <div class="Egallary">
                                ...
                                <div class="gallar-img">
                                    <img src="{{ asset('public/assets/uploads/state/' . $state->thumbnail) }}"
                                        alt="image">
                    ...
                    @if ($key == 1)
                        <div class="col-lg-12 col-md-6 col-sm-12  mb-20 mr-10 mt_gallary wow fadeInUp"
                            data-wow-duration="1000ms" data-wow-delay="450ms">
                            <div class="Egallary">
    ...
    <div class="text-center mt-5">
        <a href="{{ route('realeStateListingsFilter') }}"
            class="main-btn gallary_btn">{{ get_phrase('See More Property') }}
        ...
        <div class="row">
            <div class="col-lg-5 col-md-12 col-sm-12 mb__20">
                <div class="counter_left">
                    <h3>{{ get_phrase('A Comprehensive Directory Database') }}</h3>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            @foreach ($listings as $listing)
                ...
                @endphp
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 mb-4 wow fadeInUp" data-wow-duration="1000ms"
                    data-wow-delay="600ms">
                    <div class="slider-controls estate-product">
                        <!-- Single Product -->
                        <a
                            href="{{ route('singlePropertyView', ['slug' => $listing->slug, 'id' => $listing->id]) }}">
                            <div class="product-entry">
                                <div class="product-img">
                                    <span class="featured">{{ ucfirst($listing->type) }}</span>
                                    <img src="{{ get_listing_image_or_video($listing->id, $image) }}"
                                        alt="" />
                                ...
                                <div class="product-details">
                                    ...
                                    <p class="l_text mt-0">
                                        {{ Str::limit(strip_tags($listing->short_description), 60) }}</p>
                                    <div class="product-meta d-flex justify-content-between align-items-center">
                                        <div class="product-meta-item">
                                            <img class="bed"
                                                src="{{ asset('public/assets/real-estate/images/double.png') }}"
                                                alt="">
                                            <div>
                            ...
                            <div class="post-item antry-blog-post wow fadeInUp" data-wow-duration="1000ms"
                                ...
                                <div class="post-image">
                                    <a
                                        ...
                                        @if ($blog->thumbnail)
                                            <img src="{{ asset('public/uploads/blog/' . $blog->thumbnail) }}"
                                                alt="blog-image">
                                        @else
                                            <img src="{{ asset('public/uploads/blog/placeholder.jpg') }}"
                                                alt="...">
                                        @endif
                                    </a>
                                </div>
                                <div class="post-content mt-3">
                                    ...
                                    <a href="{{ route('blogDetails', ['slug' => slugify($blog->title), 'id' => $blog->id]) }}"
                                        class="read-more">{{ get_phrase('Read More') }}<svg width="16"
