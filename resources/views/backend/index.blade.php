    ...
    <div class="sidebar">
        <div class="logo-details mb-3">
            <div class="img_wrapper">
                ...
                @else
                    <img height="40px" src="{{ asset('public\assets\global\images\logo\hikal-logo.png') }}" alt="">
                @endif
            </div>
        </div>
        <div class="closeIcon">
        ...
        <ul class="nav-links">
            ...
            <li class="nav-links-li <?php if (request()->is('admin/settings/system*') || request()->is('admin/settings/website*') || request()->is('admin/settings/seo*') || request()->is('admin/payment/settings*') || request()->is('admin/map/settings*') || request()->is('admin/settings/smtp*') || request()->is('admin/settings/faq*') || request()->is('admin/contact/settings') || request()->is('admin/settings/about*')) {
                echo 'showMenu';
            } ?>">
                <div class="iocn-link">
                    <a href="#">
        ...
        <div class="home-content">
            ...
            <div class="main_content">
                ...
                {{-- <div class="copyright-text">
                    <p>{{ get_phrase('by') }} <a href="{{ get_settings('footer_link') }}" target="_blank">{{ get_settings('footer_text') }}</a>,
