...
@section('customerRightPanel')
    <style>
        ...
        .zoom-modal .eBtn:hover {
            background: rgb(218, 31, 38) !important;
            color: #fff !important;
        }
    </style>
    <div class="col-lg-9">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="tableIcons d-flex flex-wrap g-8">
                                            <div class="tRemoveIcon" data-bs-toggle="modal"
                                                onclick="show('{{ $appointment->appointment_to_agent->phone }}')"
                                                data-bs-target="#dlPhoneModal">
                                            ...
                                            <div class="tRemoveIcon" data-bs-toggle="modal"
                                                onclick="show_email('{{ $appointment->appointment_to_agent->email }}')"
                                                data-bs-target="#dlEmailModal">
                                                <span data-bs-toggle="tooltip" data-bs-placement="top"
                                                    data-bs-title="Email Address">
                                                    <i class="fa-solid fa-envelope"></i></span>
                                            </div>
                                            <div class="tRemoveIcon"
                                                onclick="viewproperty('<?= $appointment->appointment_to_listing->slug ?>', '<?= $appointment->listing_id ?>')">
                                                <span data-bs-toggle="tooltip" data-bs-placement="top"
                                                    data-bs-title="Property Details">
                                                    <i class="fa-solid fa-house"></i></span>
                                            </div>
                                            @if ($appointment->type == 'video')
                                                <div class="tRemoveIcon" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModal"
                                                    onclick="show_app('{{ $appointment->id }}','{{ $appointment->zoom_meeting_link }}')">
                                                    <span data-bs-toggle="tooltip" data-bs-placement="top"
                                                        data-bs-title="Join Meeting">
                                                        <i class="fa-solid fa-video"></i></span>
                                                </div>
                                            @endif
                                            <div class="tRemoveIcon"
                                                onclick="confirmModal('{{ route('deleteAppointment', ['id' => $appointment->id]) }}', 'undefined');">
                                                <span data-bs-toggle="tooltip" data-bs-placement="top"
...
@section('booking_page_modal')
    <!-- Modal Phone -->
    <div class="modal eModal fade" id="dlPhoneModal" data-bs-keyboard="false" tabindex="-1"
    ...
    <!-- Modal Email -->
    <div class="modal eModal fade" id="dlEmailModal" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered sweet-alerts">
            <div class="modal-content">
                <div class="modal-body dl-modal flex-row g-10">
    ...
    <div class="zoom-modal">
        <div class="modal eModal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                ...
                <form action="" method="POST" id="zoom">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="text" class="form-control d-none" id="zoom_meeting_link"
                                name="zoom_meeting_link" value="" readonly>
...
@section('customerjs')
    <script>
        ...
        function show_app(value, link) {
            ...
            if (link) {
                $('#test').html(
                    "<a href='link' target='_blank' id='link' class='eBtn saveChanges-btn'>{{ get_phrase('Join Now') }}</a>"
                    );
            }
            $('#link').attr('href', link);
        }
