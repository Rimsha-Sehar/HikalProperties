                      ...
                      <div class="card-body">
                        ...
                        <ul class="packageFeatures">
                         @php $service_list = json_decode($package->services); @endphp
                           ...
                           <li>
                              <svg width="23" height="21" viewBox="0 0 23 21" fill="#da1f26" xmlns="http://www.w3.org/2000/svg">
