            ...
            <div class="row flex-column-reverse flex-sm-row mt-50">
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">
                    ...
                    <div class="single-footer">
                        ...
                        @else
                        <a href="#"><img src="{{ asset('public/assets/global/images/logo/hikal-logo.png') }}" alt=""></a>
                        @endif
                        <!-- Footer Logo End -->
            ...
            <div class="row">
                {{-- <div class="col-lg-8 col-md-12">
                    <div class="copyright-text text-left">
                        <p> {{ get_phrase('by') }} <a href="{{ get_settings('footer_link') }}" target="_blank">{{ get_settings('footer_text') }}</a>, {{ get_phrase('All rights reserved') }}.</p>
                    </div>
                </div> --}}
