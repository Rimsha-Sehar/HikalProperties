                ...
                {{-- <div class="col-lg-4 col-md-6 col-sm-6 mb-3">
                    <div class="contact-icon-box text-center">
                        ...
                        <div class="icon-content">
                            <p><a href="tel:{{ get_settings('phone') }}">
                            ...
                            <div class="mb-33">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label"
                                        for="check">{{ get_phrase('I am bound by the terms of the service I accept Privacy Policy') }}.</label>
                                </div>
                            </div>
                            <!-- reCAPTCHA -->
                            @if (get_settings('recaptcha_status') == 1)
                                <div class="g-recaptcha" data-sitekey="{{ get_settings('recaptcha_sitekey') }}"></div>
                                <br />
                            @endif
