...
<head>
    ...
    <style>
        ...
        body {
            background-image: linear-gradient(to bottom right, #000000, #4c4237, #3c3b34, #5d5e59, #1E1E1E);
        }
        .language_selection {
            background-image: linear-gradient(to bottom right, var(--primary-1), var(--primary-2), var(--primary-3), var(--primary-4));
        }
        .next-language {
            color: #5a432b;
        }
        ...
        .heading-box {
            color: #000000;
            background-image: linear-gradient(to bottom right, var(--primary-1), var(--primary-2), var(--primary-3), var(--primary-4), var(--primary-1), var(--primary-2));
        }
        .countdown-text {
            border-radius: 5px;
            color: #6c462d;
