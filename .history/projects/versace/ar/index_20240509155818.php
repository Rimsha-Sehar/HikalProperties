            ...
            <div class="row container container-fluid">
                ...
                <div class="col-6 col-md-4 col-lg-3 pb-3">
                    <div class="d-flex flex-column justify-content-start align-items-center">
                        <img src="../../assets/images/icons/white/flowers.png" height="40" width="auto" class="col-4" />
                    </div>
                ...
                <div class="col-6 col-md-4 col-lg-3 pb-3">
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <img src="../../assets/images/icons/white/beach.png" width="40" class="mx-2" />
                ...
                <div class="col-6 col-md-4 col-lg-3 pb-3">
                    <div class="d-flex justify-content-start align-items-center">
                        <!-- <i class="fa-brands fa-pagelines location-icon"></i> -->
                        <img src="../../assets/images/icons/white/houses.png" width="40" class="mx-2" />
                        <div class="d-flex flex-column justify-content-start">
                            <div class="location-timing">
                                <span class="location-time px-1">
                                    15
                ...
                <div class="col-6 col-md-4 col-lg-3 pb-3">
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <img src="../../assets/images/icons/white/mall.png" width="40" class="mx-2" />
                        <div class="d-flex flex-column justify-content-start">
                            <div class="location-timing">
                                <span class="location-time px-1">
                                    17
                ...
                <div class="col-6 col-md-4 col-lg-3 pb-3">
                    <div class="d-flex justify-content-start align-items-center">
                        <!-- <i class="fa-brands fa-pagelines location-icon"></i> -->
                        <img src="../../assets/images/icons/white/palm.png" width="40" class="mx-2" />
                        <div class="d-flex flex-column justify-content-start">
                            <div class="location-timing">
                                <span class="location-time px-1">
                                    15
                ...
                <div class="col-6 col-md-4 col-lg-3 pb-3">
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <img src="../../assets/images/icons/white/burjkhalifa.png" width="40" class="mx-2" />
                        <div class="d-flex flex-column justify-content-start">
                            <div class="location-timing">
                                <span class="location-time px-1">
                                    20
                ...
                <div class="col-6 col-md-4 col-lg-3 pb-3">
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <img src="../../assets/images/icons/white/airport.png" width="40" class="mx-2" />
                        <div class="d-flex flex-column justify-content-start">
                            <div class="location-timing">
                                <span class="location-time px-1">
                                    25
