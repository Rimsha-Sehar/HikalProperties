...
<head>
    ...
    <style>
        ...
        .heading-box {
            background-image: linear-gradient(to bottom right, var(--primary-1), var(--primary-2), var(--primary-3), var(--primary-4), var(--primary-1), var(--primary-2), var(--primary-3), var(--primary-4));
        }
    </style>
</head>
