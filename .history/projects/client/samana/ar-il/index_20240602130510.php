...
$client = "true";
$client_id = 7;
$client_email = "mahaamer2920@gmail.com";
?>
            ...
            <div class="first_section">
                ...
                <div class="language-overlay">
                    <div class="language_selection">
                        <a href="https://hikalproperties.com/projects/client/samana/en-il?<?php echo $_SESSION["params"]; ?>">
                ...
                <div class="form-container" id="form-container">
                    ...
                    if ($ip == $fetch['ip'] && $filename == $fetch['filename']) {
                        ...
                        <form id="lead-form" dir="ltr" onsubmit="return submitLeadForm();">
                            <div style="display: none">
                                <input type="text" id="Project" name="Project" value="Ivy Gardens 2" />
                                <input type="text" id="Developer" name="Developer" value="Samana" />
