...
<head>
    ...
    <title>Hikal Real Estate Properties | Ivy Gardens 2</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description"
        content="Hikal Real Estate | Hikal Properties | Samana Developers | Ivy Gardens 2 by Samana Developers">
...
<body class="arabic">
    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <div class="full-body">
            ...
            <div class="first_section">
                ...
                <div class="language-overlay">
                    <div class="language_selection">
                        <a href="https://hikalproperties.com/projects/client/samana/en?<?php echo $_SESSION["params"]; ?>">
                ...
                <div class="form-container" id="form-container">
                    ...
                    if ($ip == $fetch['ip'] && $filename == $fetch['filename']) {
                        ...
                        <form id="lead-form" dir="ltr" onsubmit="return submitLeadForm();">
                            <div style="display: none">
                                <input type="text" id="Project" name="Project" value="Ivy Gardens 2 (Samana)" />
            ...
            <!-- LOCATION BENEFITS -->
            < class="third_section container container-fluid my-4 py-4">
                <h4 class="primary-text text-center">
                    مميزات الموقع
                </h4>
                < class="row container container-fluid d-flex justify-content-center">
                    < class="col-12 col-md-6 w-full p-4 d-flex flex-column justify-content-center align-items-center">
                        <h6 class="my-0 mb-2" style="font-weight: bold;" dir="ltr">
                            10 - 15 MIN
                        </h6>
                        <!-- GLOBAL VILLAGE -->
                        <h6 class="m-0">
                        ...
                        <h6 class="m-0">
                            مدرسة فيرجرين الدولية
                </h6>
                </div>
                <div class="col-12 col-md-6 w-full p-4 d-flex flex-column justify-content-center align-items-center">
                    <div class="mb-2" style="font-weight: bold;" dir="ltr">
                        15 - 20 MIN
                    </div>
