        ...
        <div class="full-body">
            ...
            <div class="third_section container container-fluid my-4 py-4">
                ...
                <div class="row container container-fluid d-flex justify-content-center">
                    <div class="col-12 col-md-6 col-lg-4 w-full p-4 d-flex justify-content-center">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 w-full p-4 d-flex flex-column justify-content-center align-items-center">
                        <div class="mb-2" style="font-weight: bold;" dir="ltr">
                            15 - 20 MIN
                        </div>


                        <div class="location-timing mb-2">
