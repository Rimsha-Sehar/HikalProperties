        ...
        <div class="full-body">
            ...
            <div class="first_section">
                ...
                <div class="language-overlay">
                    <div class="language_selection">
                        <a href="https://hikalproperties.com/projects/samana/ivy/en-de?<?php echo $_SESSION["params"]; ?>">
                    ...
                    if ($ip == $fetch['ip'] && $filename == $fetch['filename']) {
                        ...
                        <form id="lead-form" dir="ltr" onsubmit="return submitLeadForm();">
                            <div style="display: none">
                                ...
                                <input type="text" id="Country" name="Country" value="Germany" />
            ...
            <script>
                ...
                var phone_number = window.intlTelInput(minput, {
                    ...
                    preferredCountries: ["de", "ae", "sa", "qa", "om", "kw", "iq"],
                    hiddenInput: "full",
