            ...
            <div class="first_section">
                ...
                <div class="language-overlay">
                    <div class="language_selection">
                        <a href="https://hikalproperties.com/projects/samana/ivy/ar?<?php echo $_SESSION["params"]; ?>">
            ...
            <div class="second_section container container-fluid my-4 d-flex justify-content-center align-items-center">
                <div class="form-container" id="form-container">
                    ...
                    if ($ip == $fetch['ip'] && $filename == $fetch['filename']) {
                        ...
                        ?>
                        <!--NEW FORM-->
                        <form id="lead-form" dir="ltr" onsubmit="return submitLeadForm();" style="min-height: 400px;">
                            <div style="display: none">
