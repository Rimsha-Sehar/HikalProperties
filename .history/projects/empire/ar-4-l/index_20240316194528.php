...
<body class="arabic">
    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <!-- HEADING  -->
        <div class="first_section" style="background-color: var(--white);">
        ...
        <div class="container container-fluid my-5">
            ...
            <div class="row" style="justify-content: center; align-items:center;">
                <div
                    class="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-3 p-2 d-flex flex-column justify-content-center align-items-center">
