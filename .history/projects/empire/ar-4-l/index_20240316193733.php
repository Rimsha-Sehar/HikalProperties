    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <div class="container container-fluid my-5">
            ...
            <div class="row" style="justify-content: center; align-items:center;">
                <div class="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-3 p-2 d-flex justify-content-center align-items-center">
                    <div class="location">
                ...
                <div class="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-3 p-2 d-flex justify-content-center flex-column align-items-center">
                    <!-- <div class="location"> -->
                        <div class="location-box">
                            10
                        </div>
                ...
                <div class="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-3 p-2 d-flex flex-column justify-content-center align-items-center">
                    <div class="location">
                        <div class="location-box">
                            25
                        </div>
