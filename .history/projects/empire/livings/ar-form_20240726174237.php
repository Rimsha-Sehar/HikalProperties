        ...
        if ($ip == $fetch['ip'] && $filename == $fetch['filename']) {
            ...
            <form id="lead-form" dir="ltr" onsubmit="return submitLeadForm();">
                ...
                <div class="enquiry-radio" style="display: flex;">
                    <input class="mx-2" type="radio" name="EnquiryRadio1" id="EnquiryRadio1" value="Studio" required onchange="updateFields()">
                ...
                <div class="enquiry-radio" style="display: flex;">
                    <input class="mx-2" type="radio" name="EnquiryRadio1" id="EnquiryRadio2" value="Studio + Private Pool"
                ...
                <div class="enquiry-radio" style="display: flex;">
                    <input class="mx-2" type="radio" name="EnquiryRadio1" id="EnquiryRadio3" value="1 Bedroom" required onchange="updateFields()">
                ...
                <div class="enquiry-radio" style="display: flex;">
                    <input class="mx-2" type="radio" name="EnquiryRadio1" id="EnquiryRadio4"
                        value="1 Bedroom + Private Pool" required onchange="updateFields()">
                ...
                <div class="enquiry-radio" style="display: flex;">
                    <input class="mx-2" type="radio" name="EnquiryRadio1" id="EnquiryRadio5"
                        value="1 Bedroom Duplex + Private Pool" required onchange="updateFields()">
...
<script>
    function updateFields() {
        var selectedOption = document.querySelector('input[name="EnquiryRadio1"]:checked').value;

        var enquiryTypeField = document.getElementById('EnquiryRadio1');
        var projectNameField = document.getElementById('Project');

        switch (selectedOption) {
            case 'Studio':
                enquiryTypeField.value = 'Studio';
                projectNameField.value = 'Livings';
                break;
            case 'Studio + Private Pool':
                enquiryTypeField.value = 'Studio';
                projectNameField.value = 'Livings (Private Pool)';
                break;
            case '1 Bedroom':
                enquiryTypeField.value = '1 Bedroom';
                projectNameField.value = 'Livings';
                break;
            case '1 Bedroom + Private Pool':
                enquiryTypeField.value = '1 Bedroom + Private Pool';
                projectNameField.value = 'Livings (Private Pool)';
                break;
            case '1 Bedroom Duplex + Private Pool':
                enquiryTypeField.value = '1 Bedroom';
                projectNameField.value = 'Livings (Duplex + Private Pool)';
                break;
            default:
    ...
    document.querySelectorAll('input[name="EnquiryRadio1"]').forEach(function (radio) {
