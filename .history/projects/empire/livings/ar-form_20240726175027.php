            ...
            <form id="lead-form" dir="ltr" onsubmit="return submitLeadForm();">
                ...
                <div class="enquiry-radio" style="display: flex;">
                    <input class="mx-2" type="radio" name="EnquiryRadio1" id="EnquiryRadio4"
                        value="1 Bedroom + Private Pool" required onclick="updateFields()">
                ...
                <div class="enquiry-radio" style="display: flex;">
                    <input class="mx-2" type="radio" name="EnquiryRadio1" id="EnquiryRadio5"
                        value="1 Bedroom Duplex + Private Pool" required onclick="updateFields()">
...
<script>
    function updateFields() {
        ...
        var enquiryRadio1Field = document.querySelector('input[name="EnquiryRadio1"]:checked');

        switch (selectedOption) {
            case 'Studio':
                projectNameField.value = 'Livings';
                enquiryRadio1Field.value = 'Studio';
                break;
            case 'Studio + Private Pool':
                projectNameField.value = 'Livings (Private Pool)';
                enquiryRadio1Field.value = 'Studio + Private Pool';
                break;
            case '1 Bedroom':
                projectNameField.value = 'Livings';
                enquiryRadio1Field.value = '1 Bedroom';
                break;
            case '1 Bedroom + Private Pool':
                projectNameField.value = 'Livings (Private Pool)';
                enquiryRadio1Field.value = '1 Bedroom + Private Pool';
                break;
            case '1 Bedroom Duplex + Private Pool':
                projectNameField.value = 'Livings (Duplex + Private Pool)';
                enquiryRadio1Field.value = '1 Bedroom Duplex + Private Pool';
                break;
            default:
                projectNameField.value = '';
                enquiryRadio1Field.value = '';
        }
    }
