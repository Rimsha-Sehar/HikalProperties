    ...
    <div class="form-container" id="form-container" style="min-height: 400px;">
        ...
        if ($ip == $fetch['ip'] && $filename == $fetch['filename']) {
            ...
            <form id="lead-form" dir="ltr" onsubmit="return submitLeadForm();">
                ...
                <div class="enquiry-radio" style="display: flex;">
                    <input class="mx-2" type="radio" name="EnquiryRadio1" id="EnquiryRadio2" value="Studio"
                        required onchange="updateFields('Livings (Private Pool)')" />
                ...
                <div class="enquiry-radio" style="display: flex;">
                    <input class="mx-2" type="radio" name="EnquiryRadio1" id="EnquiryRadio4"
                        value="1 Bedroom + Private Pool" required onchange="updateFields('Livings (Private Pool)')" />
                ...
                <div class="enquiry-radio" style="display: flex;">
                    <input class="mx-2" type="radio" name="EnquiryRadio1" id="EnquiryRadio5"
                        value="1 Bedroom Duplex + Private Pool" required onchange="updateFields('Livings (Duplex + Private Pool')" />
    ...
    document.addEventListener("DOMContentLoaded", function () {
        document.querySelectorAll('input[name="EnquiryRadio1"]').forEach(function (radio) {
            radio.addEventListener('change', function () {
                updateFields(this.getAttribute('data-project-name'));
            });
        });
    });
</script>
