        ...
        <div class="container container-fluid my-5">
                    ...
                    <ul class="timeline">
                        <li class="timeline-item">
                            ...
                            <div class="timeline-content">
                                ...
                                <p>Nullam vel sem. Nullam vel sem. Integer ante arcu, accumsan a, consectetuer eget, posuere
                                    ut, mauris. Donec orci lectus, aliquam ut, faucibus non, euismod id, nulla. Donec vitae
                                    sapien ut libero venenatis faucibus. ullam dictum felis
            ...
            <!-- <div class="row" style="justify-content: center;">
                <div class="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-3 p-2">
                    <div class="location-box" style="display: block; text-align: center;">
                        <div style="font-size: 2.2rem; margin: 0px; font-weight: bold;">
                            05
                        </div>
                        <p style="display: flex; justify-content: center; margin: 0px;">
                            دقائق
                        </p>
                        <p class="primary-grad text-center" style="display: flex; justify-content: center; margin: 0px;">
