...
<head>
    ...
    <style>
        /* :root {
            ...
            --light-primary-color: #f7c1c3;
            --white: #FFFFFF;
            --black: #000000;
            --dark-bg-text: #333333;
            --light-bg-text: #EEEEEE;
            --primary-color-1: hsl(398, 115%, 89%);
            --primary-color-2: hsl(388, 105%, 79%);
            --primary-color-3: hsl(378, 95%, 69%);
            --primary-color-4: hsl(368, 85%, 59%);
            --primary-color-5: hsl(358, 75%, 49%);
            --primary-color-6: hsl(368, 85%, 59%);
            --primary-color-7: hsl(378, 95%, 69%);
            --primary-color-8: hsl(388, 105%, 79%);
            --primary-color-9: hsl(398, 115%, 89%);
        ...
        <div class="container container-fluid my-4 d-flex justify-content-center align-items-center">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6 d-flex justify-content-center mb-4">
                    <div class="row">
                        <div class="col-6 col-md-12 col-lg-12 d-flex justify-content-center">
