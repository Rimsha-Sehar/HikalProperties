...
<head>
    ...
    <style>
        ...
        .primary-grad {
            background-image: linear-gradient(to bottom right, var(--primary-color) 0%, var(--primary-color-1) 8%, var(--primary-color-2) 18%, var(--primary-color-3) 27%, var(--primary-color-4) 35%, var(--primary-color-5) 40%, var(--primary-color-6) 50%, var(--primary-color-7) 58%, #be8c3c 67%, #b17b32 77%, #bb8332 83%, #d4a245 88%, #e1b453 93%, #a4692a 100%);
            background-size: 150%;
