...
<head>
    ...
    <style>
        ...
        ::-webkit-scrollbar-thumb {
            background-image: linear-gradient(to bottom right, var(--primary-color-2) 0%, var(--primary-color-4) 50%, var(--primary-color) 77%, var(--primary-color-6) 88%, var(--primary-color-8) 100%);
            border-radius: 10px;
        }
