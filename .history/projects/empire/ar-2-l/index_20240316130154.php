    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <div class="section_1">
            <div class="language_selection">
                <a href="https://hikalproperties.com/projects/empire/en?<?php echo $_SESSION["params"]; ?>" style="border: 1px soid gold; border-radius: 50%;">
...
.img-wrapper img {
    ...
    animation: zoomimg 5s linear infinite alternate;
}
...
@keyframes zoomimg {
    ...
    <img src="https://hikalproperties.com/projects/assets/images/projects/empire/ee-main.jpg" style="width: 100vw;"/>
</div>
