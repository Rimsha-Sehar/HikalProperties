...
<head>
    ...
    <style>
        ...
        .language_selection {
            ...
            margin: 5px;
            padding: 3px;
            background-color: 1px solid var(--primary-color);
    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <div class="first_section">
            <div class="header_section">
                <div class="language_selection">
                    <a href="https://hikalproperties.com/projects/empire/en?<?php echo $_SESSION["params"]; ?>">
                        <div class="gold-grad d-flex align-items-center">
                            <img class="lang-flag"
            ...
            <div class="heading_section">
                ...
                <h3 class="text-expand mt-2" style="text-align: center; line-height: 1.5rem; font-size: 1rem; margin: 0;">
                    وفرصتك قبل الطرح
                </h3>
