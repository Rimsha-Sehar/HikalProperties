...
<head>
    ...
    <style>
        ...
        .text-expand {
            ...
            background-image: url('data:image/svg+xml;base64,');
            background-size: 100%;
            background-image: -webkit-gradient(linear, 50% 0%, 50% 100%, color-stop(0%, var(--primary-color-3)), color-stop(50%, #fef1a2), color-stop(100%, var(--primary-color-7)));
            background-image: -moz-linear-gradient(top, var(--primary-color-3) 0%, #fef1a2 50%, var(--primary-color-7) 100%);
            background-image: -webkit-linear-gradient(top, var(--primary-color-3) 0%, #fef1a2 50%, var(--primary-color-7) 100%);
            background-image: linear-gradient(to bottom, var(--primary-color-3) 0%, #fef1a2 50%, var(--primary-color-7) 100%);
            text-stroke: 0.5rem white;
            -webkit-text-fill-color: transparent;
            animation: textExpand 3s infinite;
            font-weight: bold;
