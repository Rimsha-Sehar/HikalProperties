...
<head>
    ...
    <style>
        ...
        .primary-grad {
            background-image: linear-gradient(to bottom right, var(--primary-color) 0%, var(--primary-color-1) 10%, var(--primary-color-2) 20%, var(--primary-color-3) 30%, var(--primary-color-4) 40%, var(--primary-color-5) 50%, var(--primary-color-6) 60%, var(--primary-color-7) 70%, var(--primary-color-8) %, var(--primary-color-9) 77%, var(--primary-color-9) 83%, var(--primary-color) 88%, var(--primary-color-2) 93%, #a4692a 100%);
            background-size: 150%;
        ...
        <div class="first_section">
            ...
            <div class="heading_section">
                <h1 class="my-2" style="text-align: center; line-height: 2rem; font-weight: 800;">
                    <span class="primary-grad-anim">تملك بأقساط </span>
                    <span class="num-glow">1%</span>
                    <span class="primary-grad-anim"> شهريا لمدة </span>
                    <span class="num-glow">80</span>
                    <span class="primary-grad-anim">شهر</span>
                </h1>
