...
<head>
    ...
    <style>
        ...
        .num-glow {
            ...
            background-image: -moz-linear-gradient(top, var(--primary-color-3) 0%, #fef1a2 50%, #bc881b 100%);
            background-image: -webkit-linear-gradient(top, var(--primary-color-3) 0%, #fef1a2 50%, #bc881b 100%);
            background-image: linear-gradient(to bottom, var(--primary-color-3) 0%, #fef1a2 50%, #bc881b 100%);
