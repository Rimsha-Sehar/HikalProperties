...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --primary-1: hsl(242, 120%, 92%);
            --primary-2: hsl(232, 110%, 82%);
            --primary-3: hsl(222, 100%, 72%);
            --primary-4: hsl(212, 90%, 62%);
            --primary-5: hsl(202, 80%, 52%);
            --primary-6: hsl(212, 90%, 62%);
            --primary-7: hsl(222, 100%, 72%);
            --primary-8: hsl(232, 110%, 82%);
            --primary-9: hsl(242, 120%, 92%);
        ...
        ::-webkit-scrollbar-thumb {
            background-image: linear-gradient(to bottom right, var(--primary-color-2) 0%, var(--primary-color-4) 50%, var(--primary-color-6) 77%, var(--primary-color-8) 88%, var(--primary) 100%);
            border-radius: 10px;
        }
        ...
        .primary-grad {
            background-image: linear-gradient(to bottom right, var(--primary) 0%, var(--primary-color-1) 10%, var(--primary-color-2) 20%, var(--primary-color-3) 30%, var(--primary-color-4) 40%, var(--primary-color-5) 50%, var(--primary-color-6) 60%, var(--primary-color-7) 70%, var(--primary-color-8) 80%, var(--primary-color-9) 90%, var(--primary) 100%);
            background-size: 150%;
        ...
        .primary-grad-anim {
            background-image: repeating-linear-gradient(to right, var(--primary) 0%, var(--primary-color-1) 10%, var(--primary-color-2) 20%, var(--primary-color-3) 30%, var(--primary-color-4) 40%, var(--primary-color-5) 50%, var(--primary-color-6) 60%, var(--primary-color-7) 70%, var(--primary-color-8) 80%, var(--primary-color-9) 90%, var(--primary) 100%);
            background-size: 150%;
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            filter: drop-shadow(0 0 1px rgba(255, 200, 0, .3));
...
<body class="arabic">
    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <button onclick="topFunction()" id="myBtn" title="Go to top" style="background: transparent;"><i
                class="fa fa-arrow-up text-primary"></i></button>
