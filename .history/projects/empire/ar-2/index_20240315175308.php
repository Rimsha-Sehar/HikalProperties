            ...
            <section>
                ...
                <div class="form-section">
                    <div class="containerform">
                        <div class="row">
                            <div class="col-0 col-md-5 col-lg-8">
                                <div class="desktop">
                                <script src="https://unpkg.com/@dotlottie/player-component@latest/dist/dotlottie-player.mjs" type="module"></script>

<dotlottie-player src="https://lottie.host/bf999f04-bfc4-4d51-a028-7a0bcbce26ee/4AWkh1LS8N.json" background="transparent" speed="1" style="width: 300px; height: 300px;" loop autoplay></dotlottie-player>
                                </div>
                            </div>
                                        ...
                                        <div class="contact-form" dir="ltr">
                                            <form id="lead-form" onsubmit="return submitLeadForm();">
                                                <div style="display: none">
                                                    ...
                                                    <input type="text" id="Country" name="Country" value="" /> <input
