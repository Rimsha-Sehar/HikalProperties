    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <div class="second_section container container-fluid my-4">
            <div class="row d-flex justify-content-center align-items-center">
                <div class="col-6 col-md-6 col-lg-4 p-2 d-flex justify-content-center align-items-center">
                    <div class="highlight-box my-2">
                        <!-- <img src="../../assets/images/icons/bed.svg" width="100" style="color: var(--secondary);" /> -->
                        <img width="48" height="48" src="https://img.icons8.com/emoji/48/bed-emoji.png" alt="bed-emoji" />
