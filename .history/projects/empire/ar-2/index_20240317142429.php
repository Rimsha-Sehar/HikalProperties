...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --black: #000000;
            --dark-bg-text: #333333;
            --light-bg-text: #f3f5ff;
            --primary-1: hsl(218, 53%, 20%);
            --primary-2: hsl(218, 63%, 30%);
            --primary-3: hsl(218, 73%, 40%);
            --primary-4: hsl(218, 83%, 50%);
            --primary-5: hsl(218, 93%, 60%);
            --primary-6: hsl(218, 103%, 70%);
            --primary-7: hsl(218, 113%, 80%);
            --primary-8: hsl(218, 123%, 90%);
            --primary-9: hsl(218, 133%, 100%);
        }
        ...
        @keyframes num-glow {
            ...
            50% {
                text-shadow: 0px 0px var(--primary-light);
            }
        ...
        input[type="radio"]:checked+label {
            background-color: linear-gradient(right, var(--primary-dark), var(--primary));
            color: #fff !important;
            border-radius: 5px;
            padding: 5px 10px;
        ...
        .language_selection {
            ...
            display: flex;
            align-items: center;
            box-shadow: 0 0 5px 1px var(--light-bg-text);
        }
        ...
        .heading-box {
            box-shadow: 0 4px 10px -5px var(--primary-dark);
            width: 95%;
            padding: 15px;
            text-align: center;
            border-radius: 30px;
    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <div class="heading_section">
            <div class="heading-box">
                <h1 class="my-2" style="text-align: center; line-height: 2rem; font-weight: 800;">
                    <span class="">تملك بأقساط </span>
                    <span class="num-glow">1%</span>
                    <span class=""> شهريا لمدة </span>
        ...
        <!-- <div class="second_section container container-fluid my-4">
            <div class="row d-flex justify-content-center align-items-start">
                ...
                <div class="col-6 col-md-4 col-lg-4 p-2 d-flex justify-content-center align-items-center">
                    <div class="highlight-box">
                        <img src="../../assets/images/icons/blue/pool.png" width="50" />
                        <div class="text-center px-2" style="font-weight: 600;">
                            مسبح خاص
                        </div>
                    </div>
        ...
        <!-- FORM -->
        <div class="second_section container container-fluid mb-4 d-flex justify-content-center align-items-center">
            <div class="row" style="width: 100%;">
                <div class="col-12 col-md-4 col-lg-6 d-flex justify-content-center mb-4">
                        ...
                        if ($ip == $fetch['ip'] && $filename == $fetch['filename']) {
                            ...
                            <form id="lead-form" dir="ltr" onsubmit="return submitLeadForm();">
                                ...
                                <div style="display: flex;" dir="rtl">
                                    ...
                                    <label for="EnquiryRadio1" style="margin-top: 0px; padding-left: 7px;">
                                        استوديو + حمام سباحة
                                    </label>
                                </div>
                                <div style="display: flex;" dir="rtl">
                                    <input class="mx-2" type="radio" name="EnquiryRadio1" id="EnquiryRadio2" value="1 Bedroom"
                                        style="width: 20px;" required>
                                    <label for="EnquiryRadio2" style="margin-top: 0px; padding-left: 7px;">
                                        غرفة نوم + حمام سباحة
                                    </label>
                                </div>
                                <div style="display: flex;" dir="rtl">
                                    <input class="mx-2" type="radio" name="EnquiryRadio1" id="EnquiryRadio3" value="2 Bedrooms"
                                        style="width: 20px;" required>
                                    <label for="EnquiryRadio3" style="margin-top: 0px; padding-left: 7px;">
                                ...
                                <div style="display: flex;" dir="rtl">
                                    <input class="mx-2" type="radio" name="EnquiryRadio1" id="EnquiryRadio4" value="3 Bedrooms"
                                        style="width: 20px;" required>
                                    <label for="EnquiryRadio4" style="margin-top: 0px; padding-left: 7px;">
                                ...
                                <div style="display: flex;" dir="rtl">
                                    <input class="mx-2" type="radio" name="LeadForRadio1" id="PurposeRadio1" value="Investment"
                                        style="width: 20px;" required>
                                    <label for="PurposeRadio1" style="margin-top: 0px; padding-left: 7px;">
                                        استثمار
                                    </label>
                                </div>
                                <div style="display: flex;" dir="rtl">
                                    <input class="mx-2" type="radio" name="LeadForRadio1" id="PurposeRadio2" value="End-user"
                                        style="width: 20px;" required>
                                    <label for="PurposeRadio2" style="margin-top: 0px; padding-left: 7px;">
                                        سكني
                                    </label>
                                </div>
                                ...
                                <div class="row d-flex align-items-end justify-content-center pb-2" dir="rtl">
                                    <div class="col-5 p-2 d-flex justify-content-center align-items-center">
                                        <button type="submit" class="submit-click">إرسال</button>
                                    </div>
                                    <div class="col-7 4 p-2 d-flex flex-column justify-content-center align-items-center">
        ...
        <div class="third_section container container-fluid my-5">
            ...
            <div class="row d-flex justify-content-center align-items-start">
                <!-- GARDEN -->
                <div class="col-6 col-md-4 col-lg-3 px-2 py-4 d-flex justify-content-start align-items-start">
                    <div class="location-icon">
                        <img src="../../assets/images/icons/blue/garden.png" width="30" />
                    </div>
                    <div class="d-flex align-items-start flex-column justify-content-start px-2">
                        <div class="px-2">
                        ...
                        <div class="primary-grad text-center px-2">
                ...
                <div class="col-6 col-md-4 col-lg-3 px-2 py-4 d-flex justify-content-start align-items-start">
                    <div class="location-icon">
                        <img src="../../assets/images/icons/blue/mall.png" width="30" />
                    </div>
                    <div class="d-flex align-items-start flex-column justify-content-start px-2">
                        <div class="px-2">
                            <span class="location-time">
                ...
                <div class="col-6 col-md-4 col-lg-3 px-2 py-4 d-flex justify-content-start align-items-start">
                    <div class="location-icon">
                        <img src="../../assets/images/icons/blue/beach.png" width="30" />
                    </div>
                    <div class="d-flex align-items-start flex-column justify-content-start px-2">
                        <div class="px-2">
                            <span class="location-time">
                ...
                <div class="col-6 col-md-4 col-lg-3 px-2 py-4 d-flex justify-content-start align-items-start">
                    <div class="location-icon">
                        <img src="../../assets/images/icons/blue/burjkhalifa.png" width="30" />
                    </div>
                    <div class="d-flex align-items-start flex-column justify-content-start px-2">
                        <div class="px-2">
                            <span class="location-time">
                ...
                <div class="col-6 col-md-4 col-lg-3 px-2 py-4 d-flex justify-content-start align-items-start">
                    <div class="location-icon">
                        <img src="../../assets/images/icons/blue/airport.png" width="30" />
                    </div>
                    <div class="d-flex align-items-start flex-column justify-content-start px-2">
                        <div class="px-2">
                            <span class="location-time">
