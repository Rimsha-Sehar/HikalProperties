            ...
            <div class="row d-flex justify-content-center align-items-center">
                <div class="col-6 col-md-4 col-lg-4 p-2 d-flex justify-content-center align-items-center">
                    <div class="highlight-box my-2">
                        <img src="../../assets/images/icons/purple/bed.png" width="100" />
                ...
                <div class="col-6 col-md-4 col-lg-4 p-2 d-flex justify-content-center align-items-center">
                    <div class="highlight-box my-2">
                        <img src="../../assets/images/icons/purple/pool.png" width="100" />
                ...
                <div class="col-6 col-md-4 col-lg-4 p-2 d-flex justify-content-center align-items-center">
                    <div class="highlight-box my-2">
                        <img src="../../assets/images/icons/purple/pin.png" width="100" />
                        <div class="text-center" style="font-weight: 600;">
