            ...
            <div class="row d-flex justify-content-center align-items-start">
                ...
                <div class="col-6 col-md-4 col-lg-3 px-2 py-4 d-flex justify-content-start align-items-start">
                    <div class="location-icon">
                        <img src="../../assets/images/icons/purple/garden.png" width="30" />
                    </div>
                ...
                <div class="col-6 col-md-4 col-lg-3 px-2 py-4 d-flex justify-content-start align-items-start">
                    <div class="location-icon">
                        <img src="../../assets/images/icons/purple/mall.png" width="30" />
                    </div>
                    <div class="d-flex align-items-start flex-column justify-content-start px-2">
                        <div class="px-2">
                            <span class="location-time">
                ...
                <div class="col-6 col-md-4 col-lg-3 px-2 py-4 d-flex justify-content-start align-items-start">
                    <div class="location-icon">
                        <img src="../../assets/images/icons/purple/beach.png" width="30" />
                    </div>
                    <div class="d-flex align-items-start flex-column justify-content-start px-2">
                        <div class="px-2">
                            <span class="location-time">
                ...
                <div class="col-6 col-md-4 col-lg-3 px-2 py-4 d-flex justify-content-start align-items-start">
                    <div class="location-icon">
                        <img src="../../assets/images/icons/purple/burjkhalifa.png" width="30" />
                    </div>
                    <div class="d-flex align-items-start flex-column justify-content-start px-2">
                        <div class="px-2">
                            <span class="location-time">
                ...
                <div class="col-6 col-md-4 col-lg-3 px-2 py-4 d-flex justify-content-start align-items-start">
                    <div class="location-icon">
                        <img src="../../assets/images/icons/purple/airport.png" width="30" />
                    </div>
                    <div class="d-flex align-items-start flex-column justify-content-start px-2">
                        <div class="px-2">
                            <span class="location-time">
