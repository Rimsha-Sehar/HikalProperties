...
<head>
    ...
    border: 1px solid #a55d07; */
            box-shadow: 0 3px 6px rgba(0, 0, 0, .16), 0 3px 6px rgba(34, 160, 231, .4);
        ...
        button:hover {
            ...
            box-shadow: 0 10px 20px rgba(0, 0, 0, 0.19), 0 6px 6px rgba(0, 0, 0, 0.23),
                inset 0 -2px 5px 1px rgba(34, 160, 231, 0.7), inset 0 -1px 1px 3px rgba(250, 227, 133, 1);
            border: 1px solid rgba(34, 160, 231, 0.6);
...
<body class="arabic">
    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <div class="second_section container container-fluid my-4">
            <div class="row d-flex justify-content-center align-items-center">
                <div class="col-6 col-md-4 col-lg-4 p-2 d-flex justify-content-center align-items-center">
                    <div class="highlight-box my-2">
                        <!-- <img src="../../assets/images/icons/bed.svg" width="100" style="color: var(--secondary);" /> -->
                        <img class="mobile" src="data:image/png;base64,">
                        <img class="desktop"
                            src="data:image/png;base64,">
                ...
                <div class="col-6 col-md-4 col-lg-4 p-2 d-flex justify-content-center align-items-center">
                    <div class="highlight-box my-2">
                        <!-- <img src="../../assets/images/icons/bed.svg" width="100" style="color: var(--secondary);" /> -->
                        <img width="48" height="48" src="https://img.icons8.com/emoji/48/person-swimming.png"
                            alt="person-swimming" />
                        <div class="text-center" style="font-weight: 600;">
                            مسبح خاص
                        </div>
                ...
                <div class="col-6 col-md-4 col-lg-4 p-2 d-flex justify-content-center align-items-center">
                    <div class="highlight-box my-2">
                        <img width="48" height="48" src="https://img.icons8.com/emoji/48/round-pushpin-emoji.png"
        ...
        <!-- FORM -->
        <div class="container container-fluid my-4 d-flex justify-content-center align-items-center">
            <div class="row">
                ...
                <div class="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-3 p-2 ">
                    <div class="location">
                        ...
                        <div class="location-name">
                            ...
                            <p class="primary-grad" style="margin: 0px;">
