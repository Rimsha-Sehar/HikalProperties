...
<body class="arabic">
    ...
    if (mysqli_num_rows($checkip) > 0) {
                    ...
                    <div class="form-container" id="form-container">
                        ...
                        if ($ip == $fetch['ip'] && $filename == $fetch['filename']) {
                            ...
                            <form id="lead-form" dir="ltr" onsubmit="return submitLeadForm();">
                                ...
                                <div class="row d-flex align-items-center justify-content-center pt-4 pb-2" dir="ltr">
        ...
        <div class="third_section container container-fluid my-5">
            ...
            <div class="row d-flex justify-content-center align-items-start">
                <!-- GARDEN -->
                <div class="col-12 col-md-6 col-lg-4 p-4 d-flex justify-content-start align-items-start">
