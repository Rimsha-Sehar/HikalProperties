...
<head>
    ...
    <style>
        ...
        button:hover {
            ...
            background-image: linear-gradient(160deg, var(--primary-light), var(--secondary), var(--primary-dark));
    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <div class="second_section container container-fluid my-5">
            <div class="row d-flex justify-content-center align-items-start">
                <div class="col-4 col-md-4 col-lg-4 p-2 d-flex justify-content-center align-items-center">
