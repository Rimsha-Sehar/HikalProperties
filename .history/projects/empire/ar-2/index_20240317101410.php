...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --primary-1: rgb(61, 48, 122);
            --primary-2: rgb(49, 37, 107);
            --primary-3: rgb(42, 31, 99);
            --primary-4: rgb(33, 23, 87);
            --primary-5: rgb(25, 15, 74);
            --primary-6: rgb(19, 10, 64);
            --primary-7: rgb(14, 6, 56);
            --primary-8: rgb(9, 3, 43);
            --primary-9: rgb(36, 30, 69);
        ...
        .primary-grad {
            background-image: linear-gradient(to bottom right, var(--primary) 0%, var(--primary) 10%, var(--primary-9) 20%, var(--primary-8) 30%, var(--primary-7) 40%, var(--primary-6) 50%, var(--primary-5) 60%, var(--primary-4) 70%, var(--primary-3) 80%, var(--primary-2) 90%, var(--primary-1) 100%);
            background-size: 150%;
