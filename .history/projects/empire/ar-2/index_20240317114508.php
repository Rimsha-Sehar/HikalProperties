...
<head>
    ...
    <style>
        ...
        button {
            ...
            background-image: linear-gradient(160deg, var(--primary-2), var(--primary-4), var(--primary-6), var(--primary-8), var(--primary));
...
<body class="arabic">
    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <!-- SPECIFICATION -->
        <div class="second_section container container-fluid my-5">
