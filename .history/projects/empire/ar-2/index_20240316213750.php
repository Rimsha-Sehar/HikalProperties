...
<body class="arabic">
    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <div class="first_section">
            <img class="image" src="https://hikalproperties.com/projects/assets/images/projects/empire/ee-main.jpg" alt="Hikal Real Estate">
            <div class="text-overlay">Your Text Overlay</div>
        </div>
