...
<body class="arabic">
    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <div class="third_section container container-fluid my-5">
            ...
            <div class="row d-flex justify-content-center align-items-start">
                <div class="col-6 col-md-4 col-lg-3 p-2 d-flex flex-column justify-content-center align-items-center">
                    <div class="d-flex align-items-center justify-content-center">
                        <img src="../../assets/images/icons/purple/garden.png" width="50" />
                        <h4 class="location-time px-2">5</h4>
                    </div>
                    <div class="primary-grad">NAME</div>
                </div>
            </div>
