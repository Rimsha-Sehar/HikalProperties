...
.radio-card label {
    ...
    background-color: lightpurple; /* Default background color */
    border-radius: 5px; /* Add some rounded corners */
    cursor: pointer; /* Change cursor to pointer to indicate interactivity */
}

input[type=radio]:checked + label {
    background-color: darkpurple; /* Change background color when checked */
...
<body class="arabic">
    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <!-- IMAGE AND LANGUAGE AND HEADING -->
