            ...
            <div class="row container container-fluid">
                ...
                <div class="col-6 col-md-4 col-lg-3 pb-3">
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <img src="../../assets/images/icons/red-purple/trees.png" width="50" class="mx-2" />
                ...
                <div class="col-6 col-md-4 col-lg-3 pb-3">
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <img src="../../assets/images/icons/red-purple/mall.png" width="50" class="mx-2" />
                        <div class="d-flex align-items-center flex-column justify-content-center">
                            <div class="location-timing">
                                <span class="location-time px-1">
                                    10
                ...
                <div class="col-6 col-md-4 col-lg-3 pb-3">
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <img src="../../assets/images/icons/red-purple/cruise.png" width="50" class="mx-2" />
                        <div class="d-flex align-items-center flex-column justify-content-center">
                            <div class="location-timing">
                                <span class="location-time px-1">
                                    25
                ...
                <div class="col-6 col-md-4 col-lg-3 pb-3">
                    <div class="d-flex justify-content-start align-items-center">
                        <!-- <i class="fa-brands fa-pagelines location-icon"></i> -->
                        <img src="../../assets/images/icons/red-purple/burjkhalifa.png" width="50" class="mx-2" />
                        <div class="d-flex align-items-center flex-column justify-content-center">
                            <div class="location-timing">
                                <span class="location-time px-1">
                                    25
