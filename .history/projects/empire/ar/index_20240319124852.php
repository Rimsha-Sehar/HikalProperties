...
<body class="arabic">
    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <div id="bottom-nav">
            <div class="row">
                <div class="col-4 d-flex justify-content-center align-items-center">
                    <a href="tel:+971585556605">
                        <i class="fa-solid fa-phone footer-icon"></i>
                    </a>
                </div>
                <div class="col-4 d-flex justify-content-center align-items-center">
                    <a href="https://wa.me/971585556605" target="_blank">
        ...
        <div class="first_section">
            <img class="main-image" src="../../assets/images/projects/empire/empire-main.jpg" alt="Hikal Real Estate">
            <!-- LANGUAGE -->
