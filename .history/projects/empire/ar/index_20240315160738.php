...
<body class="arabic" dir="rtl">
    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <div class="first_section"
            style="min-height: 100vh; background: url('../../assets/images/projects/empire/empire-new.jpg'); background-size: cover; background-repeat: no-repeat; background-position: center center; border-bottom: 1px solid #9c7625;">
