...
<body class="arabic" dir="rtl">
    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <div class="first_section"
            style="min-height: 100vh; background: url('https://hikalproperties.com/projects/assets/images/projects/empire/ee-main.jpg'); background-size: cover; background-repeat: no-repeat; background-position: center center; box-shadow: ">
