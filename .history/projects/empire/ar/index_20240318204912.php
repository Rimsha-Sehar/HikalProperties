...
<head>
    ...
    <style>
        ...
        .enquiry-radio label, .purpose-radio label {
            padding: 10px;
            background-color: var(--secondary);
            border-radius: 5px;
            cursor: pointer;
