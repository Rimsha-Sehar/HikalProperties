...
<body class="arabic">
    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <!-- LOCATION BENEFITS -->
        <div class="third_section container container-fluid my-4 pt-4">
                ...
                <div class="col-6 col-md-4 col-lg-3 p-2">
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <div class="d-flex align-items-center flex-column justify-content-center">
                            <div class="location-timing px-2">
                                <span class="location-time">
                                    5
                                </span>
                                <span class="location-minute">MIN</span>
                            </div>
                            <div class="px-2">
            ...
            <div class="row d-flex justify-content-center align-items-start" style="width: 100%;">
                <!-- GARDEN -->
