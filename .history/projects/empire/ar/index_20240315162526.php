    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <div class="third_section mt-5">
            <div class="container container-fluid py-5">
                ...
                <section class="customer-logos slick-slider">
                    ...
                    <div class="slide">
                        2
                        <img src="https://image.freepik.com/free-vector/3d-box-logo_1103-876.jpg"></div>
                    <div class="slide">
                        3
                        <img src="https://image.freepik.com/free-vector/blue-tech-logo_1103-822.jpg"></div>
                    <div class="slide">
                        4
                        <img
