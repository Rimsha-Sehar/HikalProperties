                ...
                <div class="form-container" id="form-container">
                    ...
                    if ($ip == $fetch['ip'] && $filename == $fetch['filename']) {
                        ...
                        <form id="lead-form" dir="ltr" onsubmit="return submitLeadForm();">
                            ...
                            <div class="row">
                                <div class="col-4 purpose-radio text-center" dir="rtl">
                                    <input class="" type="radio" name="LeadForRadio1" id="PurposeRadio1" value="Friday"
                                        required>
                                ...
                                <div class="col-4 purpose-radio text-center" dir="rtl">
                                    <input class="mx-2" type="radio" name="LeadForRadio1" id="PurposeRadio2" value="Saturday"
                                        required>
                                ...
                                <div class="col-4 purpose-radio text-center" dir="rtl">
                                    <input class="mx-2" type="radio" name="LeadForRadio1" id="PurposeRadio3" value="Sunday"
                                        required>
                                    <label for="PurposeRadio3" class="m-0">
                                        الأحد
                                    </label>
                                </div>
                            </div>
