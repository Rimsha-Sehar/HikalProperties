    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <div class="first_section">
            ...
            <div class="row mobile">
                <img loading="eager" class="mobile img-style" src="https://hikalproperties.ae/assets/images/lpvenice/v6.jpg" alt="HIKAL PROPERTIES" style="width: 100%" />
            </div>
            <div class="container container-fluid">
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-7 col-xl-8 ps-5 py-1">
                        <img loading="eager" class="desktop img-style" src="https://hikalproperties.ae/assets/images/lpvenice/v6.jpg" alt="HIKAL PROPERTIES" style="width: 100%" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="desktop">
                    <div class="row my-4">
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <img class="img-style" src="assets/images/lpvenice/v4.png" loading="lazy" alt="HIKAL PROPERTIES" style="width: 100%;" />
                        </div>
                    ...
                    <div class="row my-4">
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <img class="img-style" src="assets/images/lpvenice/v1.png" loading="lazy" alt="HIKAL PROPERTIES" style="width: 100%;" />
                        </div>
                    </div>
                    <div class="row my-4">
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <img class="img-style" src="assets/images/lpvenice/v5.png" loading="lazy" alt="HIKAL PROPERTIES" style="width: 100%;" />
                        </div>
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="display: flex; align-items: center;">
                            <div class="p-2">
                                <h5 class="gold-grad">
        ...
        <div class="map_section" style="display: flex; align-items: center; justify-content: space-evenly;">
            <img loading="eager" class="desktop img-style" src="https://hikalproperties.ae/assets/images/lpvenice/1416.webp" alt="HIKAL PROPERTIES" style="width: 60%" />
            <img loading="eager" class="mobile img-style" src="https://hikalproperties.ae/assets/images/lpvenice/1416.webp" alt="HIKAL PROPERTIES" style="width: 100%" />
        </div>
