...
@section('content')
    ...
    <div class="container containr-fluid my-5">
        <h1 class="d-flex justify-content-center font-weight-bold">
            Privacy Policy
        </h1>
        ...
        <p>We respect your privacy and are committed to protecting it through our compliance with this policy. This Privacy
            Policy describes:</p>
        <ul>
