...
<head>
    ...
    <meta name="description" content="Hikal Real Estate | Hikal Properties | Binghatti Developers | Mercedes-Benz Places by Binghatti | Macao">
    ...
    if (mysqli_num_rows($checkip) > 0) {
                                        ...
                                        <div class="contact-form" dir="ltr">
                                            <form id="lead-form" onsubmit="return submitLeadForm();">
                                                <div style="display: none">
                                                    ...
                                                    <input type="text" id="Country" name="Country" value="Macao" />
        ...
        <script>
            ...
            var phone_number = window.intlTelInput(minput, {
                ...
                preferredCountries: ["mo", "ie", "nl", "lu", "hk", "sg", "ae"],
                hiddenInput: "full",
