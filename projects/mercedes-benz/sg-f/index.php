...
<head>
    ...
    <meta name="description" content="Hikal Real Estate | Hikal Properties | Binghatti Developers | Mercedes-Benz Places by Binghatti | Singapore">
    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        <script>
            ...
            var phone_number = window.intlTelInput(minput, {
                ...
                preferredCountries: ["sg", "hk", "nl", "ie", "lu", "mo", "ae"],
                hiddenInput: "full",
