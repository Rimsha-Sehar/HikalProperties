            ...
            <div style="width: 100%;">
                <div class="container container-fluid pb-2 d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        <a href="https://hikalproperties.com/projects/mercedes-benz/en-f/">
                    ...
                    <div class="row my-4 d-flex align-items-center">
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="display: flex; align-items: center;">
                            <div class="p-2">
                                ...
                                <h6>
                                    عش في عالم من الرفاهية المطلقه في مرسيدس بنز بليسز، تحفة معماريه اطلقت للعالم بعد شراكه استراتيجيه بين شركه بنغاطي للتطوير ومرسيدس بنز. يقع هذا الصرح المعمارى الذي يمتد ارتفاعه الي341 مترًا في قلب دبي، يتكون من 65 طابقًا، مع دمج تكنولوجيا المنزل الذكي الحديث و حلول التحكم عن بعد الذكيه، مستوحاه من شعار فلسفة تصميمات شركه مرسيدس بنز "النقاء الحسي". أكثر من مجرد إقامة منزليه ملئ بالرفاهيه بل اسلوب حياه، فإنه يرمز إلى الأناقة، ويضع معيارًا جديدًا للعيش وسط اهم و اجمل الإطلالات الرائعة الي تحبس الأنفاس على الايقونه العالميه برج خليفة متوسطا تلك الابراج الشاهقه المحيطه به لتعطيك تجربه فريده من وحدتك لمشاهده اجمل لوحه فنيه معماريه مضيئه في العالم
                                </h6>
                            </div>
                        </div>
                    </div>
                    <div class="row my-4 d-flex align-items-center">
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="display: flex; align-items: center;">
                            <div class="p-2">
                                ...
                                <hr style="width: 50px; height: 2px; background-color: #d4a556; opacity: 0.5;">
                                <h6>
                                    في قلب وسط مدينة دبي، تعاون استثنائي بين المطور صاحب الرؤيه التطويريه الفريده و الناجحه بن غاطي والعلامة الفاخرة الأيقونية مرسيدس. بدأ التعاون في عام 2023 لتشهد شراكة مخطط لها بعناية حيث رفع عنها الستار في ديسمبر 2023. مستوحاة من فلسفة تصميمات مرسيدس بنز الي تحمل شعار "النقاء الحسي" ، لتتجاوز معايير العيش التقليدية. بعيدًا عن أن تكون مجرد إقامة، فإنه يدمج تقنيات المنزل الذكي و"حلول الحركة الذكية"، مما يقدم تجربة حياة لا مثيل لها. كل تفصيله تعكس تلاقي البراعة المعمارية و الفخامة المستوحاة عالم السيارات ، لتضع معيارًا جديدًا للعيش الفاخر.
                                </h6>
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    ...
                    <div class="row my-4 d-flex align-items-center">
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="display: flex; align-items: center;">
                            <div class="p-2">
                                ...
                                <hr style="width: 50px; height: 2px; background-color: #d4a556; opacity: 0.5;">
                                <h6>
                                    استكشف تجربة حياة معيشيه من جديد في مرسيدس بليسز، حيث الموقع الإستراتيجي في قلب مدينة دبي. مع وصول سريع الي - 5 دقائق إلى دبي مول، 22 دقيقة إلى نخلة جميرا، و20 دقيقة إلى برج العرب ، حيث يتم بنائه استراتيجيًا ليكون على بُعد 16 دقيقة من مطار دبي الدولي. إنها ليست مجرد إقامه في منزل؛ بل نمط حياة صمم بعناية لأولئك الذين يسعون إلى قمة الفخامة المعاصرة .
                                </h6>
                            </div>
                        </div>
                    </div>
