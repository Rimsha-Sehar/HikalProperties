...
<body class="english" style="background: #0E0E0E;">
    ...
    if (mysqli_num_rows($checkip) > 0) {
        ...
        $lquery = mysqli_query($con, "SELECT leadName, leadContact, leadEmail, ip FROM leads WHERE coldcall = 10 AND leadName = '$lead_name' AND leadContact = '$lead_contact' AND leadEmail = '$lead_email' AND ip = '$lead_ip' ORDER BY creationDate DESC LIMIT 1");
        $lfetch = mysqli_fetch_array($lquery);
        if (mysqli_num_rows($lquery) < 1) {
            ?>
            <div class="d-flex justify-content-center align-items-center text-center p-5" style="width: 100%; min-height: 100vh;">
                <h1 class="text-center" style="font-size: 2.2rem; line-height: 4.4rem;">
                    Kindly register before joining the live meeting for a seamless experience. Please contact 
                    <a href="tel:+97142722249" class="gold-grad" style="font-weight: bold;">+97142722249</a>
                    for further assistance!
                </h1>
            </div>
                    ...
                    <div class="d-flex align-items-center justify-content-center" style="width: 100%; min-height: 60vh">
                        <div id="loading-div" class="text-center">
                            ...
                            <h5 class="py-5">
                                ...
                                <br>
                                <br>
                                It might take up to 2 to 5 minutes.
                            </h5>
                        </div>
