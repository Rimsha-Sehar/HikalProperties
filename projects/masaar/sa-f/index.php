            ...
            <div class="container container-fluid py-2 d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="px-2 gold-grad d-flex align-items-center">
                        <img class="gold-grad lang-flag mx-1" src="https://hikalproperties.com/projects/assets/images/flags/ar.png" />
                        AR
                    </div>
                </div>
            </div>   
                    ...
                    <div class="row my-4 d-flex align-items-center">
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="display: flex; align-items: center;">
                            <div class="p-2">
                                ...
                                <h6>
                                    مشروع جديد يقدم منازل فاخرة من 2 إلى 4 غرف نوم وفلل ذات تصميم مميز من 4 إلى 6 غرف نوم في الشارقة. اكتشف أكثر المشاعر المحسنة والمهدئة لهدوء الطبيعة وجوهرها ، جنة الطبيعة والحداثة ممزوجين معاً لتقديم أسلوب حياة مريح. بيان عنوان جديد تماماً بعيداً عن العالم على بعد دقائق من المدينة الرئيسية. اكتشف نهجاً مختلفاً ، شكلاً من الجمال والأناقة يرفع من مستوى معيشتك ويلهمها ، حيث تتحرك الحياة في مكان ما 
                                </h6>
                            </div>
                        </div>
                    </div>
                    <div class="row my-4 d-flex align-items-center">
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="display: flex; align-items: center;">
                            <div class="p-2">
                                ...
                                <hr style="width: 50px; height: 2px; background-color: #d4a556; opacity: 0.5;">
                                <h6>
                                    واحدة من أجمل الأراضي حيث المساحات الخضراء الطبيعية وتوفر بيئة فريدة ونمط حياة نشط وأنيق. تدعوك مجموعة من المرافق والمساحات الخارجية والمساحات الخضراء والرياح الخضراء عبر المجتمع لقضاء بعض الوقت مع عائلتك وأحبائك للاحتفال بالحياة والاستمتاع في أوقات الفراغ والنزهات وتناول الطعام والممرات وركوب الدراجات واليوغا والتأمل. تتمتع بجمالها وأعمالها الخاصة حيث ستستمتع بالخدمات المتميزة والمساحات الطبيعية للترفيه والتسلية
                                </h6>
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    ...
                    <div class="row my-4 d-flex align-items-center">
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="display: flex; align-items: center;">
                            <div class="p-2">
                                ...
                                <hr style="width: 50px; height: 2px; background-color: #d4a556; opacity: 0.5;">
                                <h6>
                                    تاون هاوس وفيلات فاخرة
                                    <br>
                                    فخامة التصاميم والجماليات الملهمة
                                    <br>
                                    المناظر الطبيعية والمناطق العائلية
                                    <br>
                                    مساحات خضراء للنزهات والممرات والجري وركوب الدراجات والتأمل
                                    <br>
                                    الحياة أفضل وسط الطبيعة والخضرة والأشجار        
                                </h6>
                            </div>
                        </div>
                    </div>
